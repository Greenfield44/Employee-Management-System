...
namespace EmploymentManagementSystem
{
    public partial class DashBoard : Form
    {
        ...
        public string mysqlconn = "C:\\Users\\MY-PC\\Documents\\hahahaha\\management\\Sample1\\Sample1\\Employee_m_s.mdf"; // collecting all the databse details 
       ...
       private int mdepartmentid;
        ...
        //private bool VerificatiomM(string a, string b, string c, string d, string e, string f, string g)
       ...
       // private bool verificationE(string a , string b,string c,string d,string e,string f,string g ,string h , string j,string k)
       // {
      ...
      //  }
       ...
       // private int pmanagerID2 = int.Parse(PManagerComboBox.Text);
       // private int pmanagerID2 =int.Parse(PManagerComboBox.Text);
